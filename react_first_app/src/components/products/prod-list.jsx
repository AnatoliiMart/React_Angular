...
const ProdList = () => {
    ...
    return ( 
        <div>
             <ProdSorting setSorting={setSorting} sortOrder={sortOrder} activeSort={sorting}/>
            <div className='prod-container'>
               
                    {
                        productsList.sort(sortOrder[sorting]).map(product =><Product {...product} key={product.id}/>)  
                    }
            </div>
        </div>
    );
